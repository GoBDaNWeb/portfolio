...
export const projects = [
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/intercourse-app',
    ...
    },
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/crypto-react-app',
    ...
    },
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/todosh-app',
    ...
    },
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/WeatherApp',
    ...
    },
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/vue-movie-app',
        link_live_demo: null,
        status: 3,
    ...
    },
    {
        ...
        link_github: 'https://github.com/GoBDaNWeb/Kiwi',
        link_live_demo: null,
        status: 3,
        status_message: 'из-за того что я использовал в написании приложения Firebase, который заблокирован на территории РФ в данное время, приложение не работает так как запланировано.'
    },
