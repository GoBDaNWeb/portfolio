    ...
    return (
        <div className='sm:w-[400px] w-[300px] bg-zinc-700 bg-opacity-50 rounded-2xl shadow-md '>
            <div className={`bg-${project.img} relative bg-cover w-full h-80 bg-center rounded-t-2xl group`}>
                ...
                {
                    project.status !== 1
                    &&  <div className='bg-black bg-opacity-70 w-full duration-300 transition translate-y-0 sm:translate-y-[-20rem] group-hover:translate-y-0 h-[50%] rounded-t-2xl'>
                ...
                <div className='flex justify-center items-center gap-6 mt-8'>
                    <div className='flex flex-col gap-2'>
                        <div className='flex gap-1 items-center'>
                            ...
                            <a 
                                target="_blank" 
                                href={project.link_github_front} 
                                className='flex items-center gap-2 border-[1px] border-solid border-[#1A1D21] p-2 rounded-2xl hover:bg-[#1A1D21] transition group cursor-pointer'
                            >
            ...
            <div className='hidden'>
                ...
                <div className={`bg-pizza-delivery bg-center bg-no-repeat bg-cover w-full h-full`}></div> 
            </div>
        </div>
    )
}
